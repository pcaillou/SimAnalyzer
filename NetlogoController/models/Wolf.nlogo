...
breed [wolves wolf]
turtles-own [energy speed]       ;; both wolves and sheep have energy
patches-own [countdown]
wolves-own [target prime isprime]       ;; both wolves and sheep have energy
...
to setup
  ...
  create-wolves nbprime  ;; create the wolves, then initialize their variables
  [
    set speed random 100
    set target one-of sheep
    set prime self
    set isprime true
    set color brown
    set size 1.5  ;; easier to see
  ...
  [
    set speed random 100
    set isprime false
    set prime one-of (wolves with [isprime = true])
    set target ([target] of prime)
    set color red
    set size 1.5  ;; easier to see
    set energy random (2 * wolf-gain-from-food)
    setxy random-xcor random-ycor
