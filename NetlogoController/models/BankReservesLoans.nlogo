...
to bank-balance-sheet ;;update monitors
  set bank-interest sum [loanInterest] of turtles
  set bank-deposits sum [savings] of turtles
  set bank-loans sum [loans] of turtles
  set bank-reserves (reserves / 100) * (bank-deposits + bank-totalprofit)
...
to pay-interest ;;fundamental procedures
  set wallet (wallet - loanInterest)
  set bank-totalprofit (bank-totalprofit + loanInterest)
end

to saving-interest ;;fundamental procedures
  set wallet (wallet + savings * savingRate)
  set bank-totalprofit (bank-totalprofit - savings * savingRate)
end
...
to repay-a-loan [amount] ;;fundamental procedures
  ...
  set loanInterest (loanInterest - amount * LoanRate)
end
...
to-report interest-total
  report sum [loanInterest] of turtles
end
