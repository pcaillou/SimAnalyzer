...
public class GraphObserver extends StatisticalObserver  {
	...
	public static String[] DefaultValues={"0","1","","1","1","","","","","","","","","","","","","",""};
	...
	public void setParams(String[] paramvals)
	{
		try {
			...
			{
				this.WEIGHT_DEFAULT = Integer.valueOf(paramvals[6]);
			}
	...
	/**
	 * Calcule toutes les donn�es possible depuis la matrice donnee
	 * 
	 * param�tres calcules :
	 ...
	 *   - rapport de la densit� du noeud au temps t et t-1
	 *   - nombre de connections indirectes au temps t
	 *   - centralit� au temps t
	 *   
	 * @param data
	 * @param idColumn
	 * @param graphColumn
